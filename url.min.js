!(function (t) {
  ...
  var p,
    ...
    z = { ftp: 21, gopher: 70, http: 80, https: 443, ws: 80, wss: 443 };
  function E() {
    return S
      ? (p =
          p ||
  ...
  function h(t, r, e) {
    ...
    var a,
      s,
      p =
        ((s = { path: !0, query: !0, hash: !0 }),
        (a = r) &&
          y.test(a) &&
          ((s.protocol = !0),
          (s.host = !0),
          d.test(a) && (s.port = !0),
          v.test(a) && ((s.user = !0), (s.pass = !0))),
        s);
    for (n in ((i = r.match(v) || []), j))
      p[n] ? (t[n] = o[j[n]] || "") : (t[n] = "");
    if (
      ((t.protocol = t.protocol.replace(g, "")),
      (t.query = t.query.replace(m, "")),
      (t.hash = F(t.hash.replace(q, ""))),
      (t.user = F(i[1] || "")),
      (t.pass = F(i[2] || "")),
      (t.port = z[t.protocol] == t.port || 0 == t.port ? "" : t.port),
      !p.protocol &&
        C.test(r.charAt(0)) &&
        (t.path = r.split("?")[0].split("#")[0]),
      !p.protocol && e)
    ) {
      var h = new L(E().match(w)[0]),
        u = h.path.split("/"),
        c = t.path.split("/"),
    ...
    (t.path = t.path.replace(A, "/")),
      b && (t.path = t.path.replace(I, "/")),
      t.paths(t.paths()),
      (t.query = new U(t.query));
  }
  function u(t) {
    return encodeURIComponent(t).replace(e, "%27");
  }
  function F(t) {
    return (t = (t = (t = t.replace(s, " ")).replace(o, function (t, r, e, o) {
      var n = parseInt(r, 16) - 224,
        i = parseInt(e, 16) - 128;
      if (0 == n && i < 32) return t;
      var a = (n << 12) + (i << 6) + (parseInt(o, 16) - 128);
  ...
  function U(t) {
    for (var r = t.split("&"), e = 0, o = r.length; e < o; e++) {
      var n = r[e].split("="),
        i = decodeURIComponent(n[0].replace(s, " "));
      if (i) {
        var a = void 0 !== n[1] ? F(n[1]) : null;
        void 0 === this[i]
          ? (this[i] = a)
  ...
  (U.prototype.toString = function () {
    ...
    for (t in this) {
      var n = this[t];
      if (!(n instanceof Function || void 0 === n))
    ...
    (L.prototype.paths = function (t) {
      ...
      if (t && t.length && t + "" !== t) {
        for (this.isAbsolute() && (e = "/"), r = t.length; o < r; o++)
          t[o] = !o && a.test(t[o]) ? t[o] : u(t[o]);
        this.path = e + t.join("/");
      }
      for (
        o = 0,
          r = (t = ("/" === this.path.charAt(0)
            ? this.path.slice(1)
            : this.path
          ).split("/")).length;
        o < r;
    ...
    (L.prototype.encode = u),
    (L.prototype.decode = F),
    ...
    (L.prototype.toString = function () {
      return (
        ...
        (this.user && u(this.user) + (this.pass && ":" + u(this.pass)) + "@") +
        (this.host && this.host) +
        (this.port && ":" + this.port) +
        (this.path && this.path) +
